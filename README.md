...
**`./sheetsage.sh -j <YOUR_SONG>`** (download the required files [here](https://drive.google.com/drive/folders/1CGuglu7XG8nhEUYO-_tA1F5I2ib2um0X?usp=drive_link) if you cannot with `./prepare.sh -j`. If you run into error, refer to [this](https://zhuanlan.zhihu.com/p/688894010) to fix the error, with the decompositions of the given commands.)
